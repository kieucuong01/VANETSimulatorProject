 ...
 * The control panels itself are packed into a <code>JTabbedPane</code> and can
 * be found in separate classes.
 */
public final class MainControlPanel extends JPanel implements ChangeListener {
	...
	private SimulateControlPanel simulatePanel_ = new SimulateControlPanel(-1);
	...
	/**
	 * Gets the central <code>JFileChooser</code>. If it does not exist, it waits
	 * until it's created in the separate thread started from the constructor.
	 * 
	...
	public JFileChooser getFileChooser() {
		...
		if (selectedFile != null) {
			...
			if (filename.equals("scenario1.xml")) {
				simulatePanel_ = new SimulateControlPanel(1);
			} else if (filename.equals("scenario2.xml")) {
				simulatePanel_ = new SimulateControlPanel(2);
			} else if (filename.equals("scenario3.xml")) {
				simulatePanel_ = new SimulateControlPanel(3);
			}
	 ...
	 * 
	 * @param acceptAll
	 *            adds a file chooser to select all files
	 * @param acceptXML
	 *            adds a file chooser to select XML files
	 * @param acceptOSM
	 *            adds a file chooser to select OpenStreetMap-files (*.osm)
	 */
